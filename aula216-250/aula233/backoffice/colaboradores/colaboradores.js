...
btn_pesquisarPopup.addEventListener('click', (evt)=>{
    ...
    if(f_pesq.value != ""){
        ...
        const config={
                titulo: "Alerta",
                texto: "Digite o ID ou o nome da pessoa.",
                cor:"#f00",
                tipo: 'ok',
                ok: ()=>{
...
const criarLinha = (el) =>{
            ...
            img_editar.addEventListener('click', (evt)=>{
                ...
                modoJanela = "e"
                tituloPopup2.innerHTML = "Editar Pessoa"
...
btn_adicionar.addEventListener('click', (evt)=>{
    modoJanela = "n"
    tituloPopup2.innerHTML = "Nova Pessoa"
    novoColaborador.classList.remove('ocultarPopup')
    f_nome.value = ""
    f_tipoColab.value = ""
    f_status.value = ""
    ...
    .then(res=>{
        if(res.status == 200){
            if(modoJanela == "n"){
                const config={
                    titulo: "Sucesso!",
                    texto: "Pessoa adicionada com sucesso!",
                    cor:"#00a600",
                    tipo: 'ok',
                    ok: ()=>{
                        console.log('OK clicado!');
            ...
            const config={
                titulo: "ERRO",
                texto: "Erro ao adicionar pessoa.",
                cor:"#f00",
                tipo: 'ok',
                ok: ()=>{
                    console.log('OK clicado!');
