...
btn_pesq.addEventListener('click', (evt)=>{
    ...
    console.log(f_pesq);
    let endpoint =`http://localhost:1880/pesquisarcontatos/${f_pesq}/${valorpesq}`
    fetch(endpoint)
    .then(res=>res.json())
    .then(res=>{
        res.forEach(el => {
